...
# virtual methods
.method public final a(Lz4/x;)Lt1/b;
    .locals 6

    new-instance v0, Lz4/w;

    invoke-direct {v0, p1}, Lz4/w;-><init>(Lz4/x;)V

    :try_start_0
    invoke-static {v0}, Ls1/e;->o(Ljava/io/InputStream;)Ls1/e;
    ...
    invoke-direct {v2, v0}, Lt1/b;-><init>(Z)V
    ...
    invoke-virtual {p1}, Ls1/e;->m()Ljava/util/Map;
    ...
    :cond_0
    sget-object v5, Lt1/h;->a:[I

    invoke-static {v3}, Lq/i;->b(I)I
    ...
    invoke-direct {v3, v1}, Lt1/e;-><init>(Ljava/lang/String;)V

    invoke-virtual {v0}, Ls1/i;->u()Landroidx/datastore/preferences/protobuf/g;
    ...
    invoke-virtual {v0, v1, v5}, Landroidx/datastore/preferences/protobuf/g;->k(I[B)V
    ...
    invoke-virtual {v2, v3, v0}, Lt1/b;->f(Lt1/e;Ljava/lang/Object;)V
    ...
    invoke-virtual {v0}, Ls1/i;->B()Ls1/g;

    move-result-object v0

    invoke-virtual {v0}, Ls1/g;->n()Landroidx/datastore/preferences/protobuf/w;
    ...
    invoke-static {v0}, LE3/o;->K(Ljava/lang/Iterable;)Ljava/util/Set;
    ...
    invoke-virtual {v0}, Ls1/i;->A()Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lt1/b;->a()Ljava/util/Map;

    move-result-object v0

    invoke-static {v0}, LE3/B;->g(Ljava/util/Map;)Ljava/util/LinkedHashMap;

    move-result-object v0

    const/4 v1, 0x1

    invoke-direct {p1, v0, v1}, Lt1/b;-><init>(Ljava/util/LinkedHashMap;Z)V
...
.method public final b(Ljava/lang/Object;Lz4/v;)V
    .locals 6
    ...
    iget-object v2, v2, Lt1/e;->a:Ljava/lang/String;

    instance-of v3, v1, Ljava/lang/Boolean;

    if-eqz v3, :cond_0

    invoke-static {}, Ls1/i;->D()Ls1/h;
    ...
    iget-object v4, v3, Landroidx/datastore/preferences/protobuf/t;->e:Landroidx/datastore/preferences/protobuf/v;

    check-cast v4, Ls1/i;

    invoke-static {v4, v1}, Ls1/i;->q(Ls1/i;Z)V
    ...
    invoke-static {v4, v1}, Ls1/i;->r(Ls1/i;F)V
    ...
    iget-object v1, v3, Landroidx/datastore/preferences/protobuf/t;->e:Landroidx/datastore/preferences/protobuf/v;

    check-cast v1, Ls1/i;

    invoke-static {v1, v4, v5}, Ls1/i;->o(Ls1/i;D)V
    ...
    invoke-static {v4, v1}, Ls1/i;->s(Ls1/i;I)V
    ...
    invoke-static {v1, v4, v5}, Ls1/i;->l(Ls1/i;J)V
    ...
    invoke-static {v4, v1}, Ls1/i;->m(Ls1/i;Ljava/lang/String;)V
    ...
    iget-object v5, v4, Landroidx/datastore/preferences/protobuf/t;->e:Landroidx/datastore/preferences/protobuf/v;

    check-cast v5, Ls1/g;

    invoke-static {v5, v1}, Ls1/g;->l(Ls1/g;Ljava/lang/Iterable;)V
    ...
    invoke-static {v1, v4}, Ls1/i;->n(Ls1/i;Ls1/g;)V
    ...
    invoke-static {v4, v1}, Ls1/i;->p(Ls1/i;Landroidx/datastore/preferences/protobuf/g;)V
    ...
    iget-object v3, v0, Landroidx/datastore/preferences/protobuf/t;->e:Landroidx/datastore/preferences/protobuf/v;

    check-cast v3, Ls1/e;

    invoke-static {v3}, Ls1/e;->l(Ls1/e;)Landroidx/datastore/preferences/protobuf/K;

    move-result-object v3

    invoke-virtual {v3, v2, v1}, Landroidx/datastore/preferences/protobuf/K;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {v0, p2}, Lz4/u;-><init>(Lz4/v;)V
