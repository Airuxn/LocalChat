...
.method public a(ILandroid/content/Context;Ljava/lang/String;)Landroid/content/Intent;
    ...
    invoke-static {p2}, Lq2/a;->a(Landroid/content/Context;)Z
    ...
    :try_start_0
    invoke-static {p2}, Lr2/b;->a(Landroid/content/Context;)LH2/d;
    ...
    iget-object p3, p3, LH2/d;->a:Landroid/content/Context;
...
.method public b(Landroid/content/Context;I)I
    ...
    sget-object v2, Lj2/f;->b:Ljava/util/concurrent/atomic/AtomicBoolean;
    ...
    :cond_0
    sget-object v2, Lm2/p;->a:Ljava/lang/Object;

    monitor-enter v2

    :try_start_1
    sget-boolean v3, Lm2/p;->b:Z
    ...
    :cond_1
    sput-boolean v0, Lm2/p;->b:Z

    invoke-virtual {p1}, Landroid/content/Context;->getPackageName()Ljava/lang/String;

    move-result-object v3

    invoke-static {p1}, Lr2/b;->a(Landroid/content/Context;)LH2/d;
    ...
    :try_start_2
    iget-object v4, v4, LH2/d;->a:Landroid/content/Context;
    ...
    :cond_5
    :goto_4
    invoke-static {p1}, Lq2/a;->a(Landroid/content/Context;)Z

    move-result v2

    if-nez v2, :cond_9

    sget-object v2, Lq2/a;->d:Ljava/lang/Boolean;
    ...
    sput-object v2, Lq2/a;->d:Ljava/lang/Boolean;
    ...
    const-class v8, Lj2/g;

    monitor-enter v8

    :try_start_9
    sget-object v9, Lj2/g;->e:Lj2/g;

    if-nez v9, :cond_c

    sget-object v9, Lj2/n;->a:Lj2/j;

    const-class v9, Lj2/n;
    ...
    :try_start_a
    sget-object v10, Lj2/n;->c:Landroid/content/Context;
    ...
    sput-object v10, Lj2/n;->c:Landroid/content/Context;
    :try_end_a
    ...
    invoke-direct {v9, v1}, Lj2/g;-><init>(I)V

    invoke-virtual {p1}, Landroid/content/Context;->getApplicationContext()Landroid/content/Context;

    sput-object v9, Lj2/g;->e:Lj2/g;
    :try_end_d
    ...
    invoke-static {v7}, Lj2/g;->c(Landroid/content/pm/PackageInfo;)Z
    ...
    invoke-static {v6}, Lm2/p;->d(Ljava/lang/Object;)V

    invoke-static {v6}, Lj2/g;->c(Landroid/content/pm/PackageInfo;)Z
