...
.method public onActivityCreated(Landroid/app/Activity;Landroid/os/Bundle;)V
    ...
    sget p2, Landroidx/lifecycle/F;->e:I
    ...
    iget-object p2, p2, Landroidx/lifecycle/C;->k:LA2/o8;

    iput-object p2, p1, Landroidx/lifecycle/F;->d:LA2/o8;
...
.method public onActivityPaused(Landroid/app/Activity;)V
    ...
    iget v0, p1, Landroidx/lifecycle/C;->e:I

    add-int/lit8 v0, v0, -0x1

    iput v0, p1, Landroidx/lifecycle/C;->e:I

    if-nez v0, :cond_0

    iget-object v0, p1, Landroidx/lifecycle/C;->h:Landroid/os/Handler;

    invoke-static {v0}, LS3/j;->c(Ljava/lang/Object;)V

    iget-object p1, p1, Landroidx/lifecycle/C;->j:LI/t;
...
.method public onActivityStopped(Landroid/app/Activity;)V
    ...
    iget v0, p1, Landroidx/lifecycle/C;->d:I

    add-int/lit8 v0, v0, -0x1

    iput v0, p1, Landroidx/lifecycle/C;->d:I

    if-nez v0, :cond_0

    iget-boolean v0, p1, Landroidx/lifecycle/C;->f:Z

    if-eqz v0, :cond_0

    iget-object v0, p1, Landroidx/lifecycle/C;->i:Landroidx/lifecycle/v;
    ...
    iput-boolean v0, p1, Landroidx/lifecycle/C;->g:Z
