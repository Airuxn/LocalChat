...
.method public final b(Landroid/content/Context;)Ljava/lang/Object;
    ...
    invoke-direct {v1, p1, v2}, LH2/d;-><init>(Landroid/content/Context;I)V

    invoke-direct {v0, v1}, LG1/H;-><init>(Lu1/h;)V

    const/4 v1, 0x1

    iput v1, v0, LG1/H;->a:I

    sget-object v1, Lu1/i;->k:Lu1/i;

    if-nez v1, :cond_1

    sget-object v1, Lu1/i;->j:Ljava/lang/Object;

    monitor-enter v1

    :try_start_0
    sget-object v2, Lu1/i;->k:Lu1/i;

    if-nez v2, :cond_0

    new-instance v2, Lu1/i;

    invoke-direct {v2, v0}, Lu1/i;-><init>(Lu1/q;)V

    sput-object v2, Lu1/i;->k:Lu1/i;
    ...
    invoke-direct {v0, p0, p1}, Lu1/j;-><init>(Landroidx/emoji2/text/EmojiCompatInitializer;Landroidx/lifecycle/v;)V
