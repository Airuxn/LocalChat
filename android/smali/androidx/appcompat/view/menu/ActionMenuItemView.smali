...
.method public final b()Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lj/j;

    invoke-virtual {v0}, Lj/j;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public final c(Lj/j;)V
    ...
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lj/j;
    ...
    invoke-virtual {p1}, Lj/j;->getTitleCondensed()Ljava/lang/CharSequence;
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->o:Lj/a;

    if-nez p1, :cond_1

    new-instance p1, Lj/a;

    invoke-direct {p1, p0}, Lj/a;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->o:Lj/a;
...
.method public final h()V
    ...
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lj/j;
    ...
    iget-object v2, v2, Lj/j;->q:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lj/j;->e:Ljava/lang/CharSequence;
    ...
    iget-object v2, v2, Lj/j;->r:Ljava/lang/CharSequence;
    ...
    iget-object v1, v0, Lj/j;->e:Ljava/lang/CharSequence;

    :goto_4
    invoke-static {p0, v1}, Lk/S0;->a(Landroid/view/View;Ljava/lang/CharSequence;)V

    return-void

    :cond_6
    invoke-static {p0, v2}, Lk/S0;->a(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final onClick(Landroid/view/View;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->n:Lj/h;

    if-eqz p1, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lj/j;

    invoke-interface {p1, v0}, Lj/h;->a(Lj/j;)Z
...
.method public final onMeasure(II)V
    ...
    :cond_0
    invoke-super {p0, p1, p2}, Lk/C;->onMeasure(II)V
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->o:Lj/a;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0, p1}, Lj/a;->onTouch(Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public setExpandedFormat(Z)V
    ...
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->k:Lj/j;
...
.method public setIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1, v0, v0, v0}, Lk/C;->setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
...
.method public setPopupCallback(Lj/b;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->p:Lj/b;
