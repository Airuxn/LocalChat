...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-virtual {p0, v0}, Lk/X;->setBaselineAligned(Z)V
...
.method public static i(Landroid/view/ViewGroup$LayoutParams;)Lk/k;
    .locals 1
    ...
    iget-boolean p0, p0, Lk/k;->a:Z

    iput-boolean p0, v0, Lk/k;->a:Z
...
.method public final a(Lj/j;)Z
    ...
    invoke-virtual {v0, p1, v1, v2}, Lj/i;->p(Landroid/view/MenuItem;Lj/k;I)Z
...
.method public final bridge synthetic d()Lk/W;
    .locals 1
...
.method public final e(Landroid/util/AttributeSet;)Lk/W;
    .locals 2
...
.method public final bridge synthetic f(Landroid/view/ViewGroup$LayoutParams;)Lk/W;
    .locals 0
...
.method public getMenu()Landroid/view/Menu;
    ...
    invoke-direct {v2, v3, p0}, Le2/h;-><init>(ILjava/lang/Object;)V

    iput-object v2, v1, Lj/i;->e:Le2/h;

    new-instance v1, Lk/i;

    invoke-direct {v1, v0}, Lk/i;-><init>(Landroid/content/Context;)V

    iput-object v1, p0, Landroidx/appcompat/widget/ActionMenuView;->v:Lk/i;

    const/4 v0, 0x1

    iput-boolean v0, v1, Lk/i;->n:Z

    iput-boolean v0, v1, Lk/i;->o:Z
    ...
    iget-object v0, p0, Landroidx/appcompat/widget/ActionMenuView;->v:Lk/i;

    iput-object p0, v0, Lk/i;->j:Landroidx/appcompat/widget/ActionMenuView;

    iget-object v0, v0, Lk/i;->f:Lj/i;
...
.method public getOverflowIcon()Landroid/graphics/drawable/Drawable;
    ...
    :cond_0
    iget-boolean v1, v0, Lk/i;->m:Z

    if-eqz v1, :cond_1

    iget-object v0, v0, Lk/i;->l:Landroid/graphics/drawable/Drawable;
...
.method public final j(I)Z
    ...
    instance-of v3, v1, Lk/j;

    if-eqz v3, :cond_1

    check-cast v1, Lk/j;

    invoke-interface {v1}, Lk/j;->a()Z
    ...
    instance-of p1, v2, Lk/j;

    if-eqz p1, :cond_2

    check-cast v2, Lk/j;

    invoke-interface {v2}, Lk/j;->b()Z
...
.method public final onConfigurationChanged(Landroid/content/res/Configuration;)V
    ...
    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->v:Lk/i;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lk/i;->f()V

    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->v:Lk/i;

    iget-object p1, p1, Lk/i;->u:Lk/f;

    if-eqz p1, :cond_0

    invoke-virtual {p1}, Lj/n;->b()Z
    ...
    invoke-virtual {p1}, Lk/i;->g()Z

    iget-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->v:Lk/i;

    invoke-virtual {p1}, Lk/i;->h()Z
...
.method public final onLayout(ZIIII)V
    ...
    invoke-virtual {v0}, Lk/X;->getDividerWidth()I
    ...
    invoke-static {v0}, Lk/V0;->a(Landroid/view/View;)Z
...
.method public final onMeasure(II)V
    ...
    iget-object v2, v0, Landroidx/appcompat/widget/ActionMenuView;->s:Lj/i;
    ...
    invoke-virtual {v2, v4}, Lj/i;->o(Z)V
    ...
    iput-boolean v9, v5, Lk/k;->f:Z

    iput v9, v5, Lk/k;->c:I

    iput v9, v5, Lk/k;->b:I

    iput-boolean v9, v5, Lk/k;->d:Z
    ...
    invoke-virtual {v9}, Lk/C;->getText()Ljava/lang/CharSequence;
    ...
    :goto_2
    iput-boolean v9, v5, Lk/k;->e:Z

    iget-boolean v9, v5, Lk/k;->a:Z
    ...
    invoke-virtual {v11}, Lk/C;->getText()Ljava/lang/CharSequence;
    ...
    :goto_7
    iput-boolean v9, v6, Lk/k;->d:Z

    iput v11, v6, Lk/k;->b:I
    ...
    iput-boolean v3, v6, Lk/k;->f:Z

    if-nez v4, :cond_25

    iget-boolean v3, v6, Lk/k;->e:Z
    ...
    :cond_30
    invoke-super/range {p0 .. p2}, Lk/X;->onMeasure(II)V
...
.method public setExpandedActionViewsExclusive(Z)V
    ...
    iput-boolean p1, v0, Lk/i;->s:Z

    return-void
.end method

.method public setOnMenuItemClickListener(Lk/l;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->B:Lk/l;
...
.method public setOverflowIcon(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v1, p1}, Lk/r;->setImageDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput-boolean v1, v0, Lk/i;->m:Z

    iput-object p1, v0, Lk/i;->l:Landroid/graphics/drawable/Drawable;
...
.method public setPresenter(Lk/i;)V
    .locals 0

    iput-object p1, p0, Landroidx/appcompat/widget/ActionMenuView;->v:Lk/i;

    iput-object p0, p1, Lk/i;->j:Landroidx/appcompat/widget/ActionMenuView;

    iget-object p1, p1, Lk/i;->f:Lj/i;
