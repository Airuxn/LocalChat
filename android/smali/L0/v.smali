...
.method public final a(LL0/j;)V
    ...
    iget-object v1, p1, LL0/j;->a:LH0/f;

    invoke-virtual {v1}, LH0/f;->c()I

    move-result v1

    iget v3, p0, LL0/v;->b:I

    invoke-static {v3, v2, v1}, LA2/W6;->c(III)I

    move-result v1

    if-ge v0, v1, :cond_0

    invoke-virtual {p1, v0, v1}, LL0/j;->f(II)V

    return-void

    :cond_0
    invoke-virtual {p1, v1, v0}, LL0/j;->f(II)V
